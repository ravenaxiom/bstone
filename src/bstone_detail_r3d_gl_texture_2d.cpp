...
private:
	const Ren3dGlTextureMgrPtr gl_texture_manager_;
...
{
	const auto gl_mag_filter = Ren3dGlUtils::filter_get_mag(sampler_state_.mag_filter_);
...
{
	const auto gl_min_filter = Ren3dGlUtils::filter_get_min(
