...
//
// 3D-renderer command manager.
//


#ifndef BSTONE_RENDERER_3D_COMMAND_MANAGER_INCLUDED
#define BSTONE_RENDERER_3D_COMMAND_MANAGER_INCLUDED
...
#endif // !BSTONE_RENDERER_3D_COMMAND_MANAGER_INCLUDED
