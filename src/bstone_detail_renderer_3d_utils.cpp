...
bool Renderer3dUtils::is_pot_value(
		const int value)
{
...
int Renderer3dUtils::find_nearest_pot_value(
	const int value)
{
	for (int i = 0; i < 32; ++i)
	{
...
int Renderer3dUtils::calculate_mipmap_count(
	const int width,
	const int height)
{
	//
...
SdlWindowUPtr Renderer3dUtils::window_create(
...
void Renderer3dUtils::window_set_mode(
...
void Renderer3dUtils::window_show(
	SdlWindowPtr sdl_window,
...
void Renderer3dUtils::window_set_title(
...
void Renderer3dUtils::validate_initialize_param(
...
void Renderer3dUtils::validate_buffer_create_param(
...
void Renderer3dUtils::validate_buffer_update_param(
...
void Renderer3dUtils::vertex_input_validate_format(
	const Renderer3dVertexAttributeFormat attribute_format)
{
	switch (attribute_format)
	{
		case Renderer3dVertexAttributeFormat::rgba_8_unorm:
		case Renderer3dVertexAttributeFormat::rg_32_sfloat:
		case Renderer3dVertexAttributeFormat::rgb_32_sfloat:
			return;
...
void Renderer3dUtils::vertex_input_validate_param(
	...
	const Renderer3dVertexInputCreateParam& param)
{
	...
	if (param.index_buffer_->get_kind() != Renderer3dBufferKind::index)
	{
	...
	for (const auto& attribute_description : attribute_descriptions)
	{
		...
		if (attribute_description.vertex_buffer_->get_kind() != Renderer3dBufferKind::vertex)
		{
...
void Renderer3dUtils::indexed_to_rgba_8(
...
void Renderer3dUtils::indexed_npot_to_rgba_8_pot(
	const IndexedToRgba8Param& param)
{
	if (param.width_ <= 0)
	{
...
void Renderer3dUtils::indexed_to_rgba_8_pot(
	const IndexedToRgba8Param& param)
{
	const auto is_npot = (
...
void Renderer3dUtils::indexed_sprite_to_rgba_8_pot(
...
void Renderer3dUtils::rgba_8_npot_to_rgba_8_pot(
	const int width,
	const int height,
...
void Renderer3dUtils::build_mipmap(
...
void Renderer3dUtils::create_window_validate_param(
	const Renderer3dUtilsCreateWindowParam& param)
{
...
void Renderer3dUtils::create_window_set_gl_profile_and_version(
...
void Renderer3dUtils::create_window_set_gl_attributes(
	const Renderer3dUtilsCreateWindowParam& param)
{
	...
	{
		case Renderer3dAaKind::ms:
			if (param.aa_value_ >= Renderer3dLimits::aa_min_on)
			{
...
std::uint32_t Renderer3dUtils::create_window_sdl_flags(
	const Renderer3dUtilsCreateWindowParam& param)
{
	auto flags = Uint32{};
...
void Renderer3dUtils::indexed_to_rgba_8_rm_na(
	const IndexedToRgba8Param& param)
{
...
void Renderer3dUtils::indexed_to_rgba_8_rm_ha(
	const IndexedToRgba8Param& param)
{
	auto src_pixels = param.indexed_pixels_;
	const auto& src_palette = *param.indexed_palette_;
...
void Renderer3dUtils::indexed_to_rgba_8_cm_na(
	const IndexedToRgba8Param& param)
{
	const auto& src_palette = *param.indexed_palette_;
...
void Renderer3dUtils::indexed_to_rgba_8_cm_ha(
	const IndexedToRgba8Param& param)
{
	const auto& src_palette = *param.indexed_palette_;
...
void Renderer3dUtils::indexed_npot_to_rgba_8_rm_na(
	const IndexedToRgba8Param& param)
{
...
void Renderer3dUtils::indexed_npot_to_rgba_8_rm_ha(
	const IndexedToRgba8Param& param)
{
	const auto src_du_f = static_cast<double>(param.width_) / static_cast<double>(param.actual_width_);
	const auto src_dv_f = static_cast<double>(param.height_) / static_cast<double>(param.actual_height_);
...
void Renderer3dUtils::indexed_npot_to_rgba_8_cm_na(
	const IndexedToRgba8Param& param)
{
	const auto src_du_f = static_cast<double>(param.width_) / static_cast<double>(param.actual_width_);
	const auto src_dv_f = static_cast<double>(param.height_) / static_cast<double>(param.actual_height_);
...
void Renderer3dUtils::indexed_npot_to_rgba_8_cm_ha(
	const IndexedToRgba8Param& param)
{
	const auto src_du_f = static_cast<double>(param.width_) / static_cast<double>(param.actual_width_);
	const auto src_dv_f = static_cast<double>(param.height_) / static_cast<double>(param.actual_height_);
...
void Renderer3dUtils::build_mipmap_1(
