	...
	const int aa_factor)
{
	...
	if (current_aa_factor < bstone::Renderer3dLimits::aa_min_on)
	{
		current_aa_factor = bstone::Renderer3dLimits::aa_min_on;
	}
	else if (current_aa_factor > bstone::Renderer3dLimits::aa_max)
	{
		current_aa_factor = bstone::Renderer3dLimits::aa_max;
	}
	...
	const bool is_right)
{
	switch (menu_video_mode_cfg_.aa_kind_)
	{
		case bstone::Renderer3dAaKind::none:
			if (is_left)
			{
				menu_video_mode_cfg_.aa_kind_ = bstone::Renderer3dAaKind::ms;
			}
			else if (is_right)
			{
				menu_video_mode_cfg_.aa_kind_ = bstone::Renderer3dAaKind::ms;
		...
		case bstone::Renderer3dAaKind::ms:
			if (is_left)
			{
				menu_video_mode_cfg_.aa_kind_ = bstone::Renderer3dAaKind::none;
			}
			else if (is_right)
			{
				menu_video_mode_cfg_.aa_kind_ = bstone::Renderer3dAaKind::none;
	...
	const bool is_right)
{
	...
	if (aa_factor < bstone::Renderer3dLimits::aa_min_on)
	{
		aa_factor = bstone::Renderer3dLimits::aa_max;
	}
	else if (aa_factor > bstone::Renderer3dLimits::aa_max)
	{
		aa_factor = bstone::Renderer3dLimits::aa_min_on;
	}
	...
	const int anisotropy)
{
	...
	if (pot_anisotropy < bstone::Renderer3dLimits::anisotropy_min_off)
	{
		pot_anisotropy = bstone::Renderer3dLimits::anisotropy_min_off;
	}
	else if (pot_anisotropy > bstone::Renderer3dLimits::anisotropy_max)
	{
		pot_anisotropy = bstone::Renderer3dLimits::anisotropy_max;
	}
			...
			switch (i)
			{
				case static_cast<int>(TexturingMenuIndices::anisotropy):
				{
					const auto anisotropy_string = (
						vid_cfg.d3_texture_anisotropy_ > bstone::Renderer3dLimits::anisotropy_min_off ?
				...
				case static_cast<int>(TexturingMenuIndices::upscale_filter):
				{
					const auto upscale_filter_string = (
						vid_cfg.texture_upscale_kind_ == bstone::HwTextureManagerUpscaleFilterKind::none ?
						"NONE" :
						"XBRZ"
					);
	...
	const bool is_right)
{
	...
	if (anisotropy < bstone::Renderer3dLimits::anisotropy_min_off)
	{
		anisotropy = bstone::Renderer3dLimits::anisotropy_max;
	}

	if (anisotropy > bstone::Renderer3dLimits::anisotropy_max)
	{
		anisotropy = bstone::Renderer3dLimits::anisotropy_min_off;
	}
...
void texturing_filter_carousel(
	bstone::Renderer3dFilterKind& filter)
{
	switch (filter)
	{
		case bstone::Renderer3dFilterKind::nearest:
			filter = bstone::Renderer3dFilterKind::linear;
			break;

		case bstone::Renderer3dFilterKind::linear:
			filter = bstone::Renderer3dFilterKind::nearest;
			break;
	...
	const bool is_right)
{
	...
	if (vid_cfg.texture_upscale_kind_ == bstone::HwTextureManagerUpscaleFilterKind::none)
	{
		vid_cfg.texture_upscale_kind_ = bstone::HwTextureManagerUpscaleFilterKind::xbrz;
	}
	else if (vid_cfg.texture_upscale_kind_ == bstone::HwTextureManagerUpscaleFilterKind::xbrz)
	{
		vid_cfg.texture_upscale_kind_ = bstone::HwTextureManagerUpscaleFilterKind::none;
	}
