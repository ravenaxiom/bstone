...
public:
	...
	virtual void notify_destroy(
		const Ren3dShaderStagePtr shader_stage) noexcept = 0;
	...
	virtual Ren3dShaderStagePtr get_active() const noexcept = 0;

	virtual void set_active(
		const Ren3dShaderStagePtr shader_stage) = 0;


	virtual Ren3dShaderStagePtr get_current() const noexcept = 0;
